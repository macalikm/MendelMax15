...
#define STRING_CONFIG_H_AUTHOR "(CathodeRay, default config)" // Who made the changes.
//#define CUSTOM_VERSION_FILE Version.h // Path from the root directory (no quo
/**
 * *** VENDORS PLEASE READ ***
 *
...
#define CUSTOM_MACHINE_NAME "Secret Lab "

// Printer's unique ID, used by some programs to differentiate between machines.
// Choose your own or use a service like https://www.uuidgenerator.net/version4
//#define MACHINE_UUID "79dabedc-d85e-416e-9c7a-8b1936a7f1a9"
...
#define Z_MIN_PROBE_ENDSTOP_INVERTING true // mlm for BLTouch Set to true to invert the logic of the probe.
 ...
 *          'TMC2209', 'TMC2209_STANDALONE', 'TMC26X', 'TMC26X_STANDALONE', 
...
//#define ENDSTOP_INTERRUPTS_FEATURE    // mlm
 ...
 */
#define Z_MIN_PROBE_USES_Z_MIN_ENDSTOP_PIN  // mlm for BLTouch
...
#define Z_SERVO_ANGLES { 10, 90 } // mlm for bl touch
 ...
 *     O-- FRONT --+
 */
// mlm default #define NOZZLE_TO_PROBE_OFFSET { 10, 10, 0 }
#define NOZZLE_TO_PROBE_OFFSET { -27.1, -71.0, 0 }
...
#define XY_PROBE_SPEED (40*60)    //mlm default (133*60)
 ...
 */
#define Z_CLEARANCE_DEPLOY_PROBE   6 // mlm  10 Z Clearance for Deploy/Stow
 ...
 */
//#define PROBING_HEATERS_OFF       // mlm Turn heaters off when probing
#if ENABLED(PROBING_HEATERS_OFF)
  //#define WAIT_FOR_BED_HEATER     // mlm Wait for bed to heat back up between probes (to improve accuracy)
#endif
#define PROBING_FANS_OFF          // mlm Turn fans off when probing
...
#define AUTO_BED_LEVELING_BILINEAR    // mlm auto bed leveling with BLTOUCH
 ...
 */
#define DISPLAY_CHARSET_HD44780 WESTERN     //mlm JAPANESE
...
//
#define INDIVIDUAL_AXIS_HOMING_MENU   // mlm
...
//
#define REPRAP_DISCOUNT_FULL_GRAPHIC_SMART_CONTROLLER   // mlm
...
//#define NEOPIXEL_LED
  ...
  #define NEOPIXEL_PIN     P1_24    //mlm 4       // LED driving pin
...
#define NUM_SERVOS 3    // mlm For BL Touch
