...
#define CUSTOM_MACHINE_NAME "Secret Lab Mendel"
 ...
 */
//#define Z_MIN_PROBE_USES_Z_MIN_ENDSTOP_PIN  // mlm disabled for BLTouch
...
#define INVERT_X_DIR true           // set to true for stall guard
